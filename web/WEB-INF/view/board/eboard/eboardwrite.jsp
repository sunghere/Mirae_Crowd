...
<form name="frmForm" id="_frmForm" method="post" action="eboardwriteAf.do" enctype="multipart/form-data">

    <h1 class="cursive">${login.entname} Write</h1>
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8">
            <table class="table">
                ...
                <tr class="id">
                    <th>
                        <div class="form-control" style="text-align: center">ID<input type="hidden" name="ent"
                                                                                      value="${login.ent}"></div>
                    </th>
                    <td>
...
<script type="text/javascript">
    $("#_btnWrite").click(function () {
        ...
        if (title == "" || title == null) {
            ...
            $("#_frmForm").attr({"target": "_self", "action": "/eboardwriteAf.do"}).submit();
        }
    });
